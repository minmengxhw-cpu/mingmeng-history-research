...
- 视觉核验发现，原标为“香港大学《光明報》1941 年缩微胶卷”的 3 页 PDF 实为 1940 年代香港报刊总目录，并非《光明報》逐期影像；岭南 2 页 PDF 也只是剪报索引题名页。
- 两条记录已降级为馆藏/导航路线，保持 `citation_ready=false`，不进入 OCR 原件池，不关闭 1941 成立专题缺口；新增 `docs/domestic/1941_CATALOGUE_ROUTE_AUDIT_20260822.md` 固化判定依据。
