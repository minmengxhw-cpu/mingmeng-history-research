...
- 视觉复核前备份为 `/private/tmp/mingmeng_research_index_20260814_liwen_visual_review.bak`；关联写入后另存快照 `/private/tmp/mingmeng_research_index_20260814_liwen_event_links_after.bak`。正文、OCR、图片和 PDF 均未修改或删除。
