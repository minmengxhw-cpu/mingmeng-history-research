...
- `/research/parity`：HTTP 200；9 个专题、9/9 导航可用、9/9 来源地图、228 个来源地图页、0 个 `research_ready`、9 个开放原件目标。
...
- P0 主证据矩阵已按当前来源地图重建为 228 条页级记录；统一门禁新增矩阵新鲜度检查，避免来源地图更新后继续使用旧队列。
...
- 1947 解散专题重新取得并校验汉口版《大剛報》1947-11-06公开四页 PDF：SHA256 与来源地图一致，第一页版头、日期和解散标题完成视觉核验；新增本地 acquisition snapshot 仍为 `review_only`，不把同期报道升级为民盟公告原件。
- 1944 改组专题新增《民憲》第一卷第七期（1944-09-10）公开 51 页 PDF 的本地 acquisition snapshot；只复核刊期、日期和目录页身份，新增 1 条 `review_only` 页级路线，不替代 1944-09-19 改组会议记录。
- 1949 新政协专题补齐国家档案局公开代表名单影像第 8—22 页，共 15 条 `review_only` 页级路线；官方页面的 22 页连续影像现已全部登记，但尚未转录或逐人识别，不关闭完整代表名册缺口。
