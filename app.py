...
PLATFORM_META = {
    ...
    "hathitrust": {
        ...
        "cn_name": "数字图书馆联盟",
        "subtitle": "数字图书馆 / 公开出版一手资料",
        "intro": "HathiTrust 由美国大学图书馆联盟建立的数字图书馆；Internet Archive 是开放的全球数字资源平台。",
        "perspective": "公开出版物 + 当时报刊 + 准原始材料视角 —— 补足 FRUS/CIA/Wilson 之外的公开舆论与政策文本",
        "coverage": "美国政府公开出版物、Department of State Bulletin、Congressional Record、1940s-1950s 当时报刊与小册子",
        "highlights": [
            "1949 China White Paper（United States Relations with China, 1944-1949）",
            "Department of State Bulletin 1946-1950",
            "Congressional hearings / Record 中的 China aid 与 third force 讨论",
            "同期英文期刊中关于 China Democratic League / third force 的材料",
        ],
        "status": "下一批优先探勘",
        "status_class": "todo",
        "active": False,
        "todo_note": "建议先只收 primary/near-primary 材料，不把现代二手研究混入主库；第一批 5-10 份 PDF 跑通 OCR、全文搜索、页码引用与中文翻译。",
    },
}
