...
PLATFORM_META = {
    ...
    "nsarchive": {
        "name": "NSArchive",
        "long_name": "National Security Archive",
        "cn_name": "美国国家安全档案馆",
        "subtitle": "FOIA 解密专题档案",
        "intro": "乔治华盛顿大学 National Security Archive 长期通过 FOIA 收集、整理和发布美国外交安全文件，专题页面通常提供稳定元数据、PDF 与引用说明。",
        "perspective": "FOIA 专题档案视角 —— 高质量解密文件，但中国民主同盟主轴命中密度较低",
        "coverage": "中美关系、冷战中国、尼克松/卡特时期对华政策等专题",
        "highlights": [
            "China policy briefing books",
            "U.S.-China rapprochement / normalization documents",
            "冷战后期中美、中苏、美台政策文件",
        ],
        "status": "专题扩展候选",
        "status_class": "todo",
        "active": False,
        "todo_note": "页面与 PDF 工程上最顺，但 1941-1950 民盟直接命中较少；建议作为后续中美关系专题库，而不是下一主数据源。",
    },
    "hathitrust": {
        "name": "HathiTrust / IA",
        ...
        "intro": "HathiTrust 由美国大学图书馆联盟建立的数字图书馆；Internet Archive 是开放的全球数字资源平台。本平台首批接入 1946-1947 香港英文报纸（China Mail / Hong Kong Telegraph 等）对民盟事件的当时报道。",
        "perspective": "1940s 香港英文报刊 + 公开出版物视角 —— 民盟解散事件等的当时舆论现场记录",
        "coverage": "1946-1949 香港 China Mail / Hong Kong Telegraph 共 23 期，覆盖民盟史关键节点：1946 政协 → 1946 国民大会 → 1947 民盟「非法」 → 1948 民盟香港复盘 → 1949 张澜上海软禁",
        "highlights": [
            "1947-10-24 / 10-29 / 10-30 / 11-05 China Mail：民盟被宣布「非法」+ 总部解散全过程港媒系列报道",
            "1948-01-06 / 02-03 / 03-02 / 03-09 China Mail：民盟香港一届三中全会前后港媒持续追踪",
            "1948-05-19 China Mail：响应中共「五一口号」前后",
            "1946-01-28 / 01-29 / 02-01 / 02-26 China Mail：1946 政协会议召开与决议落幕",
            "1946-11-26 / 11-27 China Mail：国民大会期间 + 民盟参与态度",
            "1949-01-07 China Mail：张澜（民盟主席）上海软禁期",
        ],
        "status": "已上线（23 期港媒）",
        "status_class": "active",
        "active": True,
