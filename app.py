...
PLATFORM_META = {
    ...
    "hathitrust": {
        ...
        "coverage": "1946 政协会议 / 1946 国民大会 / 1947.10 民盟被宣布「非法」 / 1947.11 民盟总部解散 等 7 期港媒（China Mail 系列）",
        "highlights": [
            "1947-10-29 / 10-30 China Mail：民盟被国民党宣布「非法」事件的香港当时报道",
            "1947-11-05 China Mail：民盟总部正式解散后续",
            "1946-01-28 / 01-29 China Mail：1946 政协会议召开期间港媒视角",
            "1946-11-26 China Mail：国民大会召开 + 民盟参与态度报道",
        ],
        "status": "已上线（第一批 7 期港媒）",
        "status_class": "active",
        "active": True,
        "todo_note": "",
    },
