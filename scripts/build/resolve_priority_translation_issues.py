...
1. 中国民主同盟成员张东荪从天津致函消息来源，称中共不仅不愿在取得彻底胜利之前结束当前内战，而且预期第三次世界大战即将爆发，并已为此作准备。

2. 张东荪表示，他毕生致力于和平事业，但如今局势已无可救药。

【校订说明】

本件原始 OCR 混有大量页眉、密级、解密戳记和误识别词。中文侧保留正文情报要点，并统一采用“中国民主同盟”“张东荪”“天津”“中共”“内战”“第三次世界大战”等译名。""",
    ),
    754: (
        "human-reviewed",
        """**档案编号：** APRF，45全宗，1目录，329卷，9-17页
**日期：** 1949年12月16日
**主题：** 斯大林与中华人民共和国中央人民政府主席毛泽东会谈记录

**引文：**
《斯大林与中华人民共和国中央人民政府主席毛泽东会谈记录，1949年12月16日》，威尔逊中心“历史与公共政策项目”数字档案，俄罗斯联邦总统档案馆，45全宗，1目录，329卷，9-17页。丹尼·罗扎斯译。

**摘要：**
毛泽东与斯大林首次会晤。双方讨论战争与和平问题，以及中苏新条约问题。斯大林以雅尔塔协定为由反对签订新条约，毛泽东承诺重新考虑其立场。毛泽东表示赞成苏联军队继续驻留旅顺，斯大林承诺不会“离开”中国。毛泽东请求提供3亿美元贷款，并请求苏联协助解放台湾。斯大林告诫毛泽东，不要给美国人提供干涉中国的借口。毛泽东表示，有几个国家有兴趣与中国建立外交关系，但中国应暂缓行事。斯大林同意这一策略。

**原文语言：** 俄文

【校订说明】

本页为馆藏元数据和摘要页，核心价值在于记录1949年12月中苏高层会谈对新中国外交、安全和台湾问题的判断。""",
    ),
    774: (
        "human-reviewed",
        """8. 中国革命通过资产阶级、农民、工人和城市小资产阶级的联盟而取得胜利。但由于领导革命的集团具有妥协性质，未能给农民带来真正利益，并屈服于帝国主义和封建势力的压力，国家政权落入北洋军阀袁世凯手中，革命遂告失败。

9. 小说《水浒传》中的一位英雄人物，在景阳冈赤手空拳打死了一只老虎。这是该著名小说中最广为人知的章节之一。

10. 关于农业社会化与国家工业化之间的关系，参见毛泽东同志于1955年7月31日在中共省、市、自治区党委书记会议上所作的报告《关于农业合作化问题》第七、第八节。该报告以苏联经验和中国实践为基础，进一步发展了农业社会化应与社会主义工业化同步推进的论点。

11. 此引文出自朱熹对儒家经典《中庸》第十三章的注释。""",
    ),
    867: (
        "human-excerpt",
        """【相关段落摘译】

本页为香港英文报纸混栏 OCR，内容跨越国际评论、希腊内战、满洲战局和中国政情短讯。可辨识段落讨论法西斯主义与共产主义在战争动员、国家主义和常备军问题上的相似性，并进一步报道共产党组织、美国援助压力、北平和满洲战局等信息。

其中与中国研究较相关的部分包括：共产党军队在中条山一带包围国民党部队，共产党第七次攻势仍在满洲地区推进，并似乎已占领沈阳。该页对民盟本身不是直接材料，但可作为1947年前后香港英文舆论把中国内战、第三方面政治空间和国际冷战语境并置观察的背景材料。

【校订说明】

原始 OCR 噪声较多，中文侧采用相关背景摘译；希腊内战地名、人名和残缺栏文不逐字展开。""",
    ),
    844: (
        "human-excerpt",
        """【相关段落摘译】
...
def upsert_translation(conn: sqlite3.Connection, page_id: int, text: str, status: str) -> None:
    ...
    if row:
        ...
        conn.execute(
            ...
            (text, status, "小班-priority-qc-2026-05-23", tid),
        )
    else:
        cur = conn.execute(
            "INSERT INTO translations(page_id, language, translator, status, text) VALUES (?, 'zh-CN', ?, ?, ?)",
            (page_id, "小班-priority-qc-2026-05-23", status, text),
        )
        tid = cur.lastrowid
    try:
