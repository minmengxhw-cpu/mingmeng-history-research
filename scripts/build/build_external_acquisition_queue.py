...
KWEW_ITEMS = [
    ...
    },
    {
        ...
        "ref": "CO 537/3724 / HKMS184-2-10",
        "title": "China Democratic League",
        "date": "1948",
        "access": "HKPRO @PRO 显示 Unrestricted；网页无直接下载，需 Access Application / 预约或申请影像；Kew 未数字化作为备份路径",
        "next_action": "优先走 HKPRO Access Application，确认页数、影像取得方式和复制限制",
        "url": "https://search.grs.gov.hk/en/search.xhtml?q=HKMS184-2-10",
        "note": "1948 民盟在港复盘与改组，殖民部高密级通信；HKPRO 原始参考号 CO 537/3724。",
    },
    {
        "priority": "A4",
        "archive": "The National Archives, Kew / HKPRO",
        ...
        "note": "1949 民盟在港总部、北上与新政协前后港英殖民政府视角；HKPRO 原始参考号 CO 537/4820。",
    },
]
