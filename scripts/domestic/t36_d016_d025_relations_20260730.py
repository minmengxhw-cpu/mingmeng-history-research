#!/usr/bin/env python3
"""T36 sub-routine — Build dossier subgraphs for D016-D025."""
...
PERIOD = {
    "D016_民盟地方组织形成": "1941-1949",
    "D017_西南联大知识分子与民盟": "1938-1946",
    "D018_香港恢复活动": "1947-1949",
    "D019_民盟与新政协": "1948-1949",
    "D020_新中国初期参政": "1949-1957",
    "D021_1957年后的组织经历": "1957-1976",
    "D022_改革开放后的组织恢复": "1977-2000",
    "D023_民盟盟史编纂史": "1949-2000",
    "D024_民盟与中国多党合作制度形成": "1949-2000",
    "D025_民盟参政议政史": "1949-2000",
}
...
def build(d):
    dossier_id = d.name
    period = PERIOD.get(dossier_id, "1940-2000")
...
def main():
    ...
    out = RESEARCH_DIR / "T36_D016_D025_SUBGRAPH_ACCEPTANCE.json"
