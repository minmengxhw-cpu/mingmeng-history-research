...
def main() -> int:
    ...
    print(json.dumps({"domestic_sources": source_count, "domestic_candidates": candidate_count, "pending_review": pending_count, "editorial_decisions": decision_count}, ensure_ascii=False))
    return 0
