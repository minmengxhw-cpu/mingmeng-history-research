...
KEY_EVENTS = [
    ...
    # ╔══════════════════════════════════════════════════════════════
    # ║ Ⅴ. 建国初期与历次政治运动期（1949 - 1976）
    # ╚══════════════════════════════════════════════════════════════
    # 注：1957 反右事件超出当前 FRUS 1941-1950 数据库覆盖范围，
    # 但作为民盟史关键事件保留，供 Wilson Center / CIA FOIA 等后续档案补充。
    {
        "slug": "chang-lo-alliance-1957",
        "name": "章罗联盟反右运动",
        "phase": "p4-mao-era-1949-1976",
        "date_label": "1957.6",
        "sort_date": "1957-06-08",
        "summary": (
            "**1957 年 6 月**反右运动扩大化，民盟受到严重挫折。"
            "**章伯钧**（交通部长）作为「章罗联盟」第一号被撤职批斗；"
            "**罗隆基**（森林工业部长）作为「章罗联盟」第二号被撤销职务。"
            "民盟主席沈钧儒在压力下做出政治表态。这一事件使民盟"
            "在 1949 年后建立的政治地位遭受重创，多位中央副主席被划为右派。"
            "（FRUS 1941-1950 数据库不覆盖此时期，材料将由后续档案补充。）"
        ),
        "search_terms": [
            "Chang Po-chun", "Lo Lung-chi", "anti-rightist",
            "章罗联盟", "反右", "1957",
        ],
        "related_persons": ["chang-po-chun", "lo-lung-chi", "shen-chun-ju"],
    },
    {
        "slug": "chu-an-ping-party-rule-1957",
        "name": "储安平「党天下」论",
        "phase": "p4-mao-era-1949-1976",
        "date_label": "1957.6.1",
        "sort_date": "1957-06-01",
        "summary": (
            "**1957 年 6 月 1 日**，民盟中央委员、《光明日报》总编辑**储安平**"
            "在最高国务会议发言提出「**党天下**」论点，"
            "迅速被打成大右派撤职批斗。1966 年文革爆发后失踪，至今下落不明。"
            "「党天下」论是民盟知识分子在 1957 整风—反右转折点上"
            "最具代表性的政治批评，也是民盟文化界受难的标志性事件。"
            "（FRUS 1941-1950 数据库不覆盖此时期，材料将由后续档案补充。）"
        ),
        "search_terms": [
            "Chu An-ping", "party rule", "Guangming Daily",
            "储安平", "党天下", "光明日报", "1957",
        ],
        "related_persons": ["chu-an-ping"],
    },
]
...
EVENT_PHASES = [
    ...
    ("p4-mao-era-1949-1976",
     "Ⅳ. 香港复盘、新政协与建国后历次政治运动期（1947.12 - 1976）"),
    ("p5-reform-1979",
