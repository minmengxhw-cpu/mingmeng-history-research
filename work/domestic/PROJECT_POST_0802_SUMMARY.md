...
| 0802 14:3x | **`738d81525c09bbff09266db00e54916bf1ec220ee169751bf1b64f3fb0626944`** | **S3 批量补采：138 候选/398 页入库**（wikimedia pdf 现成 OCR 全量复用；parse_pdf_pages 支持顿号页码；idx_page_prov_page_key 加 document_id；+6 FRUS +1 wikisource 对账） |
