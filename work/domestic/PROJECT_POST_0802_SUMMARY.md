...
| 0802 14:3x | **`8458c82e3ecc46ad5658b4cc5220b11735b7fd5a9373304882719f2b90913f37`** | **S3 批量补采：138 候选/398 页入库**（wikimedia pdf 现成 OCR 全量复用；parse_pdf_pages 支持顿号页码；idx_page_prov_page_key 加 document_id；+6 FRUS +1 wikisource 对账） |
